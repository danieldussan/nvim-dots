return {
  ...
  -- Setup LSP Saga
  {
    ...
    keys = {
      -- LSP Finder
      { "<leader>jf", "<cmd>Lspsaga finder<CR>", desc = "LSP Finder" },
      -- Go to definition
      { "<leader>jd", "<cmd>Lspsaga goto_definition<CR>", desc = "Go to Definition" },
      -- Go to type definition
      { "<leader>jt", "<cmd>Lspsaga goto_type_definition<CR>", desc = "Go to Type Definition" },
      -- Peek definition
      { "<leader>jp", "<cmd>Lspsaga peek_definition<CR>", desc = "Peek Definition" },
      -- Tog<leader>le Outline
      { "<leader>js", "<cmd>Lspsaga outline<CR>", desc = "Toggle Outline" },
      -- Hover Doc
      { "<leader>jh", "<cmd>Lspsaga hover_doc<CR>", desc = "Hover Doc" },
      -- Incoming call
      { "<leader>ji", "<cmd>Lspsaga incoming_calls<CR>", desc = "Incoming Call" },
      -- Outgoing call
      { "<leader>jo", "<cmd>Lspsaga outgoing_calls<CR>", desc = "Outgoing Call" },
      -- Code action
      { "<leader>ja", "<cmd>Lspsaga code_action<CR>", desc = "Code Action" },
      -- Source action
      {
        "<leader>jA",
        function()
      ...
      { "<leader>jr", "<cmd>Lspsaga rename<CR>", desc = "Rename" },
